  ...
  return (
    <section id="top" className="relative overflow-hidden">
      <div className="container-content grid items-center gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:py-28">
        <div>
          <p className="eyebrow mb-4">L'agenda des alternants &amp; jeunes pros · Beta rentrée 2026</p>
          ...
          <p className="mt-6 max-w-xl text-lg leading-relaxed text-slate">
            Bientôt, Calendz synchronisera Google, Outlook et iCloud sans mélanger
            ton école, ton boulot et ton perso. L'agenda intelligent pensé pour les
            alternants et les jeunes pros.
          </p>
